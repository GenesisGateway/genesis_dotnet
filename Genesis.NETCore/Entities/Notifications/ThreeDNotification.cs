...
namespace Genesis.NetCore.Entities.Notifications
{
    ...
    {
        public ThreeDNotification(NameValueCollection notificationParameters)
        {
            UniqueId = notificationParameters.Get("unique_id");
        ...
        public string ReferenceTransactionUniqueId { get; set; }
