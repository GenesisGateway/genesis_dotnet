...
{
    /// <summary>
    /// This helper class is used by <see cref="describe_genesis_client"/> tests, to mock web requests.
    /// </summary>
    /// <typeparam name="T">request entity</typeparam>
    /// <typeparam name="S">success response entity</typeparam>
    /// <typeparam name="E">error response entity</typeparam>
