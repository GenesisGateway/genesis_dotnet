...
{
    [TestClass]
    public class describe_response_Challenge
    {
        [TestMethod]
        public void it_should_deserialize_success_challenge_response()
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2ChallangeSuccessResponse();
        ...
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2ChallangeReconcileSuccessResponse();
