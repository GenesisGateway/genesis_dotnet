...
{
    [TestClass]
    public class describe_response_FallbackWith3dSecure
    {
        [TestMethod]
        public void it_should_deserialize_success_fallback_with_3d_secure_response()
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2FallbackWith3dSecureSuccessResponse();
        ...
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2FallbackWith3dSecureReconcileSuccessResponse();
