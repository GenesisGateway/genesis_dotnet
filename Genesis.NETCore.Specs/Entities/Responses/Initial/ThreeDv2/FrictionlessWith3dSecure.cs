...
{
    [TestClass]
    public class describe_response_FrictionlessWith3dSecure
    {
        [TestMethod]
        public void it_should_deserialize_success_frictionless_with_3d_secure_response()
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2FrictionlessWith3dSecureSuccessResponse();
        ...
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2FrictionlessWith3dSecureReconcileSuccessResponse();
