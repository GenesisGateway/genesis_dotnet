...
{
    [TestClass]
    public class describe_response_ChallengeWith3dSecure
    {
        [TestMethod]
        public void it_should_deserialize_success_challenge_with_3d_secure_response()
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2ChallangeWith3dSecureSuccessResponse();
        ...
        {
            var successResponseMock = ResponseMocksFactory.Create3dV2ChallangeWith3dSecureReconcileSuccessResponse();
