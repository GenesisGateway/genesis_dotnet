...
{
    [TestClass]
    public class describe_result_factory
    {
        [TestMethod]
        public void it_should_parse_sale_success_response()
        {
        ...
        [TestMethod]
        public void it_should_parse_sale_error_response()
        {
        ...
        [TestMethod]
        public void it_should_parse_reconcile_success_response()
        {
        ...
        [TestMethod]
        public void it_should_parse_reconcile_error_response()
        {
        ...
        [TestMethod]
        public void it_should_parse_reconcile_by_date_range_success_response()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
        ...
        [TestMethod]
        public void it_should_parse_reconcile_by_date_range_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<payment_response>" +
                                   "<status>error</status>" +
        ...
        [TestMethod]
        public void it_should_parse_chargeback_success_response()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                     "<chargeback_response>" +
        ...
        [TestMethod]
        public void it_should_parse_chargeback_success_response_2()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                     "<chargeback_response>" +
                                     "<type>1st chargeback </type>" +
        ...
        [TestMethod]
        public void it_should_parse_chargeback_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<chargeback_response>" +
        ...
        [TestMethod]
        public void it_should_parse_chargeback_by_date_range_success_response()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
        ...
        [TestMethod]
        public void it_should_parse_chargeback_by_date_range_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<chargeback_response>" +
                                   "<status>error</status>" +
        ...
        [TestMethod]
        public void it_should_parse_retrieval_request_success_response()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
        ...
        [TestMethod]
        public void it_should_parse_retrieval_request_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<retrieval_request_response>" +
        ...
        [TestMethod]
        public void it_should_parse_retrieval_request_by_date_range_success_response()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
        ...
        [TestMethod]
        public void it_should_parse_retrieval_request_by_date_range_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<retrieval_request_response>" +
                                   "<status>error</status>" +
        ...
        [TestMethod]
        public void it_should_parse_wpf_reconcile_response_of_successful_payment()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                     "<wpf_payment>" +
                                     "<status>approved</status>" +
        ...
        [TestMethod]
        public void it_should_parse_wpf_reconcile_response_of_voided_payment()
        {
            var successResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                     "<wpf_payment>" +
        ...
        [TestMethod]
        public void it_should_parse_init_recurring_sale_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<payment_response>" +
        ...
        [TestMethod]
        public void it_should_parse_recurring_sale_error_response()
        {
            var errorResponseXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                   "<payment_response>" +
        ...
        [TestMethod]
        public void it_should_parse_authorize_success_response_with_code_element()
        {
