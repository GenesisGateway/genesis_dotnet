...
//      for file genesis_dotnet\Genesis.NET\Entities\Responses\Error\SingleRetrievalRequestErrorResponse.cs.
//
...
namespace Genesis.Net.Entities.Responses.Error
{
	...
	public partial class SingleRetrievalRequestErrorResponse : pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.ITransactionStatusModelRequirements, pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.IErrorModelRequirements, global::CopaceticSoftware.pMixins.ConversionOperators.IContainMixin<global::Genesis.Net.Entities.Responses.TransactionStatusModel>, global::CopaceticSoftware.pMixins.ConversionOperators.IContainMixin<global::Genesis.Net.Entities.Responses.ErrorModel>
	{
		private sealed class __Mixins
		{
			...
			public __Mixins (SingleRetrievalRequestErrorResponse target)
			{
				Genesis_Net_Entities_Responses_TransactionStatusModel = global::CopaceticSoftware.pMixins.Infrastructure.MixinActivatorFactory.GetCurrentActivator ().CreateInstance<__pMixinAutoGenerated.Genesis_Net_Entities_Responses_TransactionStatusModel.TransactionStatusModelMasterWrapper> ((pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.ITransactionStatusModelRequirements)target);
				Genesis_Net_Entities_Responses_ErrorModel = global::CopaceticSoftware.pMixins.Infrastructure.MixinActivatorFactory.GetCurrentActivator ().CreateInstance<__pMixinAutoGenerated.Genesis_Net_Entities_Responses_ErrorModel.ErrorModelMasterWrapper> ((pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.IErrorModelRequirements)target);
			}
			[global::CopaceticSoftware.pMixins.Attributes.MixedInMemberAttribute]
			[global::System.Diagnostics.DebuggerStepThrough]
			public void __ActivateMixinDependencies (Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse target)
			{
		...
		private sealed class __pMixinAutoGenerated
		{
			public sealed class Genesis_Net_Entities_Responses_TransactionStatusModel
			{
				...
				{
					public TransactionStatusModelMasterWrapper (pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.ITransactionStatusModelRequirements target)
					{
						_mixinInstance = base.TryActivateMixin<pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.TransactionStatusModelAbstractWrapper> (target);
			...
			public sealed class Genesis_Net_Entities_Responses_ErrorModel
			{
				...
				{
					public ErrorModelMasterWrapper (pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.IErrorModelRequirements target)
					{
						_mixinInstance = base.TryActivateMixin<pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.ErrorModelAbstractWrapper> (target);
						base.Initialize (target, _mixinInstance, new global::System.Collections.Generic.List<global::CopaceticSoftware.pMixins.Interceptors.IMixinInterceptor> {
...
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.__Shared
{
	[global::System.CodeDom.Compiler.GeneratedCodeAttribute ("pMixin", "0.6.0.457")]
...
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel
{
	[global::System.CodeDom.Compiler.GeneratedCodeAttribute ("pMixin", "0.6.0.457")]
	public interface ITransactionStatusModelRequirements : global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.__Shared.ISharedRequirements
	{
	}
}
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel
...
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel
{
	...
	{
		private readonly global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.ITransactionStatusModelRequirements _target;
		public TransactionStatusModelAbstractWrapper (global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.TransactionStatusModel.ITransactionStatusModelRequirements target) : base ()
		{
			_target = target;
		}
	}
}
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel
{
	[global::System.CodeDom.Compiler.GeneratedCodeAttribute ("pMixin", "0.6.0.457")]
	public interface IErrorModelRequirements : global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.__Shared.ISharedRequirements
	{
	}
}
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel
...
namespace pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel
{
	...
	{
		private readonly global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.IErrorModelRequirements _target;
		public ErrorModelAbstractWrapper (global::pMixins.AutoGenerated.Genesis.Net.Entities.Responses.Error.SingleRetrievalRequestErrorResponse.Genesis.Net.Entities.Responses.ErrorModel.IErrorModelRequirements target) : base ()
		{
			_target = target;
		}
	}
